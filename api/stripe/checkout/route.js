...
export async function POST(req){
  ...
  try{
    ...
    const params = {
      ...
      success_url: body.successUrl || `${origin}/rep?stripe=success&customerId=${encodeURIComponent(body.customerId || body.leadId || '')}&session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: body.cancelUrl || `${origin}/rep?stripe=cancelled&customerId=${encodeURIComponent(body.customerId || body.leadId || '')}`,
